...
namespace esphome {
namespace guition_mipi_dsi {

constexpr static const char *const TAG = "display.guition_mipi_dsi";
...
class GUITION_MIPI_DSI : public display::Display {
 public:
  GUITION_MIPI_DSI(size_t width, size_t height, display::ColorBitness color_depth, uint8_t pixel_mode)
